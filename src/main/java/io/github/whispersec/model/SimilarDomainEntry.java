 ...
 */
@JsonPropertyOrder({
  SimilarDomainEntry.JSON_PROPERTY_DOMAIN,
  SimilarDomainEntry.JSON_PROPERTY_TECHNIQUE
})
...
public class SimilarDomainEntry {
  ...
  public enum TechniqueEnum {
    ...
    @JsonCreator
    public static TechniqueEnum fromValue(String value) {
      for (TechniqueEnum b : TechniqueEnum.values()) {
  ...
  @jakarta.annotation.Nonnull
  private TechniqueEnum technique;

  public SimilarDomainEntry() {
  }

  public SimilarDomainEntry domain(@jakarta.annotation.Nonnull String domain) {
  ...
  public SimilarDomainEntry technique(@jakarta.annotation.Nonnull TechniqueEnum technique) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_TECHNIQUE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_TECHNIQUE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTechnique(@jakarta.annotation.Nonnull TechniqueEnum technique) {
    this.technique = technique;
  }
  ...
  public boolean equals(Object o) {
    ...
    SimilarDomainEntry similarDomainEntry = (SimilarDomainEntry) o;
    return Objects.equals(this.domain, similarDomainEntry.domain) &&
        Objects.equals(this.technique, similarDomainEntry.technique);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, technique);
  }
