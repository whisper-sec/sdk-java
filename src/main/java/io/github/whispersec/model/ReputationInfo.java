...
public class ReputationInfo {
  ...
  public ReputationInfo riskScore(@javax.annotation.Nullable Double riskScore) {
  ...
  public ReputationInfo blacklists(@javax.annotation.Nullable BlacklistScores blacklists) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BLACKLISTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBlacklists(@javax.annotation.Nullable BlacklistScores blacklists) {
    this.blacklists = blacklists;
  }

  public ReputationInfo domainReputation(@javax.annotation.Nullable DomainReputationScores domainReputation) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DOMAIN_REPUTATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDomainReputation(@javax.annotation.Nullable DomainReputationScores domainReputation) {
    this.domainReputation = domainReputation;
  }
