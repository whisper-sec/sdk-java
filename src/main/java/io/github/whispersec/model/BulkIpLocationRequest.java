 ...
 */
@JsonPropertyOrder({
  BulkIpLocationRequest.JSON_PROPERTY_IPS
})
...
public class BulkIpLocationRequest {
  public static final String JSON_PROPERTY_IPS = "ips";
  @jakarta.annotation.Nonnull
  private List<String> ips = new ArrayList<>();

  public BulkIpLocationRequest() {
  }

  public BulkIpLocationRequest ips(@jakarta.annotation.Nonnull List<String> ips) {
    
    this.ips = ips;
    return this;
  }

  public BulkIpLocationRequest addIpsItem(String ipsItem) {
    if (this.ips == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IPS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIps(@jakarta.annotation.Nonnull List<String> ips) {
    this.ips = ips;
  }
  ...
  public boolean equals(Object o) {
    ...
    BulkIpLocationRequest bulkIpLocationRequest = (BulkIpLocationRequest) o;
    return Objects.equals(this.ips, bulkIpLocationRequest.ips);
  }
  ...
  public String toString() {
    ...
    sb.append("class BulkIpLocationRequest {\n");
