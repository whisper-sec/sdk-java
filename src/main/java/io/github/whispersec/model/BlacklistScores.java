...
public class BlacklistScores {
  ...
  public BlacklistScores ipScore(@javax.annotation.Nullable Double ipScore) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IP_SCORE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIpScore(@javax.annotation.Nullable Double ipScore) {
    this.ipScore = ipScore;
  }

  public BlacklistScores prefixScore(@javax.annotation.Nullable Double prefixScore) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PREFIX_SCORE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrefixScore(@javax.annotation.Nullable Double prefixScore) {
    this.prefixScore = prefixScore;
  }

  public BlacklistScores asnScore(@javax.annotation.Nullable Double asnScore) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ASN_SCORE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAsnScore(@javax.annotation.Nullable Double asnScore) {
    this.asnScore = asnScore;
  }
