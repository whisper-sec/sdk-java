 ...
 */
@JsonPropertyOrder({
  RateLimitError.JSON_PROPERTY_ERROR,
  RateLimitError.JSON_PROPERTY_MESSAGE,
  RateLimitError.JSON_PROPERTY_RETRY_AFTER
})
...
public class RateLimitError {
  ...
  public RateLimitError error(@jakarta.annotation.Nonnull String error) {
  ...
  public RateLimitError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Human-readable error message with rate limit category
   * @return message
   */
  @jakarta.annotation.Nonnull
  ...
  public RateLimitError retryAfter(@jakarta.annotation.Nonnull Integer retryAfter) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_RETRY_AFTER, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_RETRY_AFTER, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRetryAfter(@jakarta.annotation.Nonnull Integer retryAfter) {
    this.retryAfter = retryAfter;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(error, message, retryAfter);
  }
