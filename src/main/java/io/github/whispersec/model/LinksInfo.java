...
public class LinksInfo {
  ...
  public LinksInfo total(@javax.annotation.Nullable Integer total) {
  ...
  public LinksInfo topSources(@javax.annotation.Nullable List<String> topSources) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TOP_SOURCES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTopSources(@javax.annotation.Nullable List<String> topSources) {
    this.topSources = topSources;
  }
