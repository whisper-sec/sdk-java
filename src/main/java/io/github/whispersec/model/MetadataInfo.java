...
public class MetadataInfo {
  ...
  public MetadataInfo dataSources(@javax.annotation.Nullable List<String> dataSources) {
  ...
  public MetadataInfo errors(@javax.annotation.Nullable List<String> errors) {
