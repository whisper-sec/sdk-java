...
import io.github.whispersec.model.JobSummary;
...
@JsonPropertyOrder({
  ...
  JobListResponse.JSON_PROPERTY_STATUS
})
...
public class JobListResponse {
  ...
  public JobListResponse jobs(@jakarta.annotation.Nullable List<JobSummary> jobs) {
    
    this.jobs = jobs;
    return this;
  }

  public JobListResponse addJobsItem(JobSummary jobsItem) {
    if (this.jobs == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_JOBS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setJobs(@jakarta.annotation.Nullable List<JobSummary> jobs) {
    this.jobs = jobs;
  }

  public JobListResponse total(@jakarta.annotation.Nullable Long total) {
  ...
  public JobListResponse limit(@jakarta.annotation.Nullable Integer limit) {
  ...
  public JobListResponse offset(@jakarta.annotation.Nullable Integer offset) {
  ...
  public JobListResponse status(@jakarta.annotation.Nullable String status) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jobs, jobListResponse.jobs) &&
        ...
        Objects.equals(this.status, jobListResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobs, total, limit, offset, status);
  }
