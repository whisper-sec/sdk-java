 ...
 */
@JsonPropertyOrder({
  SimilarCasesResult.JSON_PROPERTY_INDICATORS,
  SimilarCasesResult.JSON_PROPERTY_STATUS,
  SimilarCasesResult.JSON_PROPERTY_ERROR,
  SimilarCasesResult.JSON_PROPERTY_MESSAGE,
  SimilarCasesResult.JSON_PROPERTY_SIMILAR_CASES
})
...
public class SimilarCasesResult {
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<Object> similarCases = JsonNullable.<Object>of(null);

  public SimilarCasesResult() {
  }

  public SimilarCasesResult indicators(@jakarta.annotation.Nullable List<String> indicators) {
    
    this.indicators = indicators;
    return this;
  }

  public SimilarCasesResult addIndicatorsItem(String indicatorsItem) {
  ...
  public SimilarCasesResult status(@jakarta.annotation.Nullable String status) {
  ...
  public SimilarCasesResult error(@jakarta.annotation.Nullable Boolean error) {
  ...
  public SimilarCasesResult message(@jakarta.annotation.Nullable String message) {
  ...
  public SimilarCasesResult similarCases(@jakarta.annotation.Nullable Object similarCases) {
    this.similarCases = JsonNullable.<Object>of(similarCases);
  ...
  public Object getSimilarCases() {
        return similarCases.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_SIMILAR_CASES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getSimilarCases_JsonNullable() {
    return similarCases;
  }
  
  @JsonProperty(JSON_PROPERTY_SIMILAR_CASES)
  public void setSimilarCases_JsonNullable(JsonNullable<Object> similarCases) {
    this.similarCases = similarCases;
  }

  public void setSimilarCases(@jakarta.annotation.Nullable Object similarCases) {
    this.similarCases = JsonNullable.<Object>of(similarCases);
  }
  ...
  public boolean equals(Object o) {
    ...
    SimilarCasesResult similarCasesResult = (SimilarCasesResult) o;
    return Objects.equals(this.indicators, similarCasesResult.indicators) &&
        Objects.equals(this.status, similarCasesResult.status) &&
        Objects.equals(this.error, similarCasesResult.error) &&
        Objects.equals(this.message, similarCasesResult.message) &&
        equalsNullable(this.similarCases, similarCasesResult.similarCases);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(indicators, status, error, message, hashCodeNullable(similarCases));
  }
