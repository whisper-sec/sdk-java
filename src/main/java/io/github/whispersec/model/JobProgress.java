...
public class JobProgress {
  ...
  public JobProgress current(@javax.annotation.Nullable Integer current) {
  ...
  public JobProgress total(@javax.annotation.Nullable Integer total) {
  ...
  public JobProgress message(@javax.annotation.Nullable String message) {
  ...
  public JobProgress percentage(@javax.annotation.Nullable Double percentage) {
