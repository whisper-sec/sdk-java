...
import io.github.whispersec.model.MonitorResultResponse;
 ...
 */
@JsonPropertyOrder({
  MonitorResultListResponse.JSON_PROPERTY_CHECK_ID,
  MonitorResultListResponse.JSON_PROPERTY_COUNT,
  MonitorResultListResponse.JSON_PROPERTY_RESULTS
})
...
public class MonitorResultListResponse {
  ...
  @jakarta.annotation.Nullable
  private List<MonitorResultResponse> results = new ArrayList<>();

  public MonitorResultListResponse() {
  }

  public MonitorResultListResponse checkId(@jakarta.annotation.Nullable String checkId) {
  ...
  public MonitorResultListResponse count(@jakarta.annotation.Nullable Integer count) {
  ...
  public MonitorResultListResponse results(@jakarta.annotation.Nullable List<MonitorResultResponse> results) {
    
    this.results = results;
    return this;
  }

  public MonitorResultListResponse addResultsItem(MonitorResultResponse resultsItem) {
  ...
  public List<MonitorResultResponse> getResults() {
    return results;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RESULTS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResults(@jakarta.annotation.Nullable List<MonitorResultResponse> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitorResultListResponse monitorResultListResponse = (MonitorResultListResponse) o;
    return Objects.equals(this.checkId, monitorResultListResponse.checkId) &&
        Objects.equals(this.count, monitorResultListResponse.count) &&
        Objects.equals(this.results, monitorResultListResponse.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkId, count, results);
  }
