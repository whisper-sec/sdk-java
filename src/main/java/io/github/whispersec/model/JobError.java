...
public class JobError {
  ...
  public JobError code(@javax.annotation.Nullable String code) {
  ...
  public JobError message(@javax.annotation.Nullable String message) {
  ...
  public JobError details(@javax.annotation.Nullable String details) {
  ...
  public JobError timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
