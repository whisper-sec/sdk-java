 ...
 */
@JsonPropertyOrder({
  InvestigateResult.JSON_PROPERTY_INDICATOR,
  InvestigateResult.JSON_PROPERTY_INDICATOR_TYPE,
  InvestigateResult.JSON_PROPERTY_STATUS,
  InvestigateResult.JSON_PROPERTY_ERROR,
  InvestigateResult.JSON_PROPERTY_MESSAGE,
  InvestigateResult.JSON_PROPERTY_INVESTIGATION
})
...
public class InvestigateResult {
  ...
  public static final String JSON_PROPERTY_INVESTIGATION = "investigation";
  @jakarta.annotation.Nullable
  private JsonNullable<Object> investigation = JsonNullable.<Object>of(null);

  public InvestigateResult() {
  }

  public InvestigateResult indicator(@jakarta.annotation.Nullable String indicator) {
  ...
  /**
   * The indicator that was investigated
   * @return indicator
   */
  @jakarta.annotation.Nullable
  ...
  public InvestigateResult indicatorType(@jakarta.annotation.Nullable IndicatorTypeEnum indicatorType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATOR_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIndicatorType(@jakarta.annotation.Nullable IndicatorTypeEnum indicatorType) {
    this.indicatorType = indicatorType;
  }

  public InvestigateResult status(@jakarta.annotation.Nullable StatusEnum status) {
  ...
  public InvestigateResult error(@jakarta.annotation.Nullable Boolean error) {
  ...
  /**
   * Whether an error occurred during investigation
   * @return error
   */
  @jakarta.annotation.Nullable
  ...
  public InvestigateResult message(@jakarta.annotation.Nullable String message) {
  ...
  public InvestigateResult investigation(@jakarta.annotation.Nullable Object investigation) {
    this.investigation = JsonNullable.<Object>of(investigation);
  ...
  public Object getInvestigation() {
        return investigation.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_INVESTIGATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getInvestigation_JsonNullable() {
    return investigation;
  }
  
  @JsonProperty(JSON_PROPERTY_INVESTIGATION)
  public void setInvestigation_JsonNullable(JsonNullable<Object> investigation) {
    this.investigation = investigation;
  }

  public void setInvestigation(@jakarta.annotation.Nullable Object investigation) {
    this.investigation = JsonNullable.<Object>of(investigation);
  }
  ...
  public boolean equals(Object o) {
    ...
    InvestigateResult investigateResult = (InvestigateResult) o;
    return Objects.equals(this.indicator, investigateResult.indicator) &&
        Objects.equals(this.indicatorType, investigateResult.indicatorType) &&
        Objects.equals(this.status, investigateResult.status) &&
        Objects.equals(this.error, investigateResult.error) &&
        Objects.equals(this.message, investigateResult.message) &&
        equalsNullable(this.investigation, investigateResult.investigation);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(indicator, indicatorType, status, error, message, hashCodeNullable(investigation));
  }
  ...
  public String toString() {
    ...
    sb.append("class InvestigateResult {\n");
