...
public class SimilarDomainsOpsRequest {
  ...
  public SimilarDomainsOpsRequest domain(@javax.annotation.Nonnull String domain) {
  ...
  public SimilarDomainsOpsRequest options(@javax.annotation.Nullable SimilarDomainRequest options) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPTIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(@javax.annotation.Nullable SimilarDomainRequest options) {
    this.options = options;
  }
