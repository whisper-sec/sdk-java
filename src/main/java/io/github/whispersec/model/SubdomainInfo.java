...
public class SubdomainInfo {
  ...
  public SubdomainInfo subdomain(@javax.annotation.Nonnull String subdomain) {
  ...
  public SubdomainInfo ipAddresses(@javax.annotation.Nullable List<String> ipAddresses) {
  ...
  public SubdomainInfo firstSeen(@javax.annotation.Nullable OffsetDateTime firstSeen) {
  ...
  public SubdomainInfo lastSeen(@javax.annotation.Nullable OffsetDateTime lastSeen) {
  ...
  public SubdomainInfo recordType(@javax.annotation.Nullable RecordTypeEnum recordType) {
  ...
  public SubdomainInfo status(@javax.annotation.Nullable StatusEnum status) {
  ...
  public SubdomainInfo technologies(@javax.annotation.Nullable List<String> technologies) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TECHNOLOGIES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTechnologies(@javax.annotation.Nullable List<String> technologies) {
    this.technologies = technologies;
  }

  public SubdomainInfo riskScore(@javax.annotation.Nullable Integer riskScore) {
