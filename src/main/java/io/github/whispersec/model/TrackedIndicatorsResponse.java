...
import io.github.whispersec.model.TrackedIndicator;
 ...
 */
@JsonPropertyOrder({
  TrackedIndicatorsResponse.JSON_PROPERTY_COUNT,
  TrackedIndicatorsResponse.JSON_PROPERTY_MAX_TRACKED,
  TrackedIndicatorsResponse.JSON_PROPERTY_INDICATORS
})
...
public class TrackedIndicatorsResponse {
  public static final String JSON_PROPERTY_COUNT = "count";
  @jakarta.annotation.Nullable
  private Integer count;

  public static final String JSON_PROPERTY_MAX_TRACKED = "max_tracked";
  @jakarta.annotation.Nullable
  private Integer maxTracked;

  public static final String JSON_PROPERTY_INDICATORS = "indicators";
  @jakarta.annotation.Nullable
  private List<TrackedIndicator> indicators = new ArrayList<>();

  public TrackedIndicatorsResponse() {
  }

  public TrackedIndicatorsResponse count(@jakarta.annotation.Nullable Integer count) {
  ...
  public TrackedIndicatorsResponse maxTracked(@jakarta.annotation.Nullable Integer maxTracked) {
  ...
  /**
   * Maximum number of indicators that can be tracked per API key
   * @return maxTracked
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_MAX_TRACKED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getMaxTracked() {
    return maxTracked;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_TRACKED, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaxTracked(@jakarta.annotation.Nullable Integer maxTracked) {
    this.maxTracked = maxTracked;
  }

  public TrackedIndicatorsResponse indicators(@jakarta.annotation.Nullable List<TrackedIndicator> indicators) {
    
    this.indicators = indicators;
    return this;
  }

  public TrackedIndicatorsResponse addIndicatorsItem(TrackedIndicator indicatorsItem) {
  ...
  public List<TrackedIndicator> getIndicators() {
    return indicators;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INDICATORS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIndicators(@jakarta.annotation.Nullable List<TrackedIndicator> indicators) {
    this.indicators = indicators;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrackedIndicatorsResponse trackedIndicatorsResponse = (TrackedIndicatorsResponse) o;
    return Objects.equals(this.count, trackedIndicatorsResponse.count) &&
        Objects.equals(this.maxTracked, trackedIndicatorsResponse.maxTracked) &&
        Objects.equals(this.indicators, trackedIndicatorsResponse.indicators);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, maxTracked, indicators);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrackedIndicatorsResponse {\n");
    sb.append("    count: ").append(toIndentedString(count)).append("\n");
    sb.append("    maxTracked: ").append(toIndentedString(maxTracked)).append("\n");
