...
public class CorrelateRequest {
  ...
  /**
   * List of indicators (IPs, domains, hashes) to correlate across global threat intelligence. Maximum 100 indicators per request.
   * @return indicators
   */
  @jakarta.annotation.Nonnull
  ...
  /**
   * Optional configuration object for correlation analysis. NOT a string - must be an object with fields like timeWindow, minConfidence, etc.
   * @return options
   */
  @jakarta.annotation.Nullable
