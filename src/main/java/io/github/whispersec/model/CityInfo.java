 ...
 */
@JsonPropertyOrder({
  CityInfo.JSON_PROPERTY_NAME,
  CityInfo.JSON_PROPERTY_ORIGINAL_NAME,
  CityInfo.JSON_PROPERTY_CONFIDENCE
})
...
public class CityInfo {
  ...
  public CityInfo name(@jakarta.annotation.Nullable String name) {
  ...
  public CityInfo originalName(@jakarta.annotation.Nullable String originalName) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_ORIGINAL_NAME, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public CityInfo confidence(@jakarta.annotation.Nullable Integer confidence) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, cityInfo.name) &&
        Objects.equals(this.originalName, cityInfo.originalName) &&
        Objects.equals(this.confidence, cityInfo.confidence);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, originalName, confidence);
  }
