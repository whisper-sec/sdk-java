...
@JsonPropertyOrder({
  ...
  InvestigateContext.JSON_PROPERTY_INDUSTRY,
  InvestigateContext.JSON_PROPERTY_REGION
})
...
public class InvestigateContext {
  ...
  /**
   * Initial hypothesis or suspicion to focus the investigation. The AI will attempt to prove or disprove this theory.
   * @return hypothesis
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Related indicators (IPs, domains, hashes) to include in the investigation scope. Helps identify connections between indicators.
  ...
  /**
   * Time range for historical analysis. Format: number + unit (d&#x3D;days, w&#x3D;weeks, m&#x3D;months). Examples: 7d, 2w, 3m, 90d
   * @return timeRange
   */
  @jakarta.annotation.Nullable
  ...
  public InvestigateContext industry(@jakarta.annotation.Nullable String industry) {
  ...
  /**
   * Industry sector for contextualized threat analysis. Helps identify industry-specific threats and attack patterns.
   * @return industry
   */
  @jakarta.annotation.Nullable
  ...
  public InvestigateContext region(@jakarta.annotation.Nullable String region) {
  ...
  /**
   * Geographic region for localized threat intelligence. Helps identify region-specific threats.
   * @return region
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hypothesis, investigateContext.hypothesis) &&
        ...
        Objects.equals(this.industry, investigateContext.industry) &&
        Objects.equals(this.region, investigateContext.region);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hypothesis, relatedIndicators, timeRange, industry, region);
  }
