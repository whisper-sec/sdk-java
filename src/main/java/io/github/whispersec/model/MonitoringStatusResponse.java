...
import io.github.whispersec.model.MonitoringMetrics;
 ...
 */
@JsonPropertyOrder({
  MonitoringStatusResponse.JSON_PROPERTY_TARGET,
  MonitoringStatusResponse.JSON_PROPERTY_STATUS,
  MonitoringStatusResponse.JSON_PROPERTY_METRICS
})
...
public class MonitoringStatusResponse {
  ...
  public MonitoringStatusResponse target(@jakarta.annotation.Nullable String target) {
  ...
  /**
   * The target domain or IP being monitored
   * @return target
   */
  @jakarta.annotation.Nullable
  ...
  public MonitoringStatusResponse status(@jakarta.annotation.Nullable StatusEnum status) {
  ...
  public MonitoringStatusResponse metrics(@jakarta.annotation.Nullable MonitoringMetrics metrics) {
  ...
  @JsonProperty(value = JSON_PROPERTY_METRICS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetrics(@jakarta.annotation.Nullable MonitoringMetrics metrics) {
    this.metrics = metrics;
  }
  ...
  public boolean equals(Object o) {
    ...
    MonitoringStatusResponse monitoringStatusResponse = (MonitoringStatusResponse) o;
    return Objects.equals(this.target, monitoringStatusResponse.target) &&
        Objects.equals(this.status, monitoringStatusResponse.status) &&
        Objects.equals(this.metrics, monitoringStatusResponse.metrics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(target, status, metrics);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MonitoringStatusResponse {\n");
