...
public class HistoryResponse {
  ...
  public HistoryResponse query(@javax.annotation.Nullable QueryInfo query) {
  ...
  public HistoryResponse history(@javax.annotation.Nullable HistoryData history) {
  ...
  @JsonProperty(value = JSON_PROPERTY_HISTORY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHistory(@javax.annotation.Nullable HistoryData history) {
    this.history = history;
  }
