 ...
 */
@JsonPropertyOrder({
  AttributeResult.JSON_PROPERTY_INDICATORS,
  AttributeResult.JSON_PROPERTY_STATUS,
  AttributeResult.JSON_PROPERTY_ERROR,
  AttributeResult.JSON_PROPERTY_MESSAGE,
  AttributeResult.JSON_PROPERTY_ATTRIBUTION
})
...
public class AttributeResult {
  ...
  @jakarta.annotation.Nullable
  private JsonNullable<Object> attribution = JsonNullable.<Object>of(null);

  public AttributeResult() {
  }

  public AttributeResult indicators(@jakarta.annotation.Nullable List<String> indicators) {
    
    this.indicators = indicators;
    return this;
  }

  public AttributeResult addIndicatorsItem(String indicatorsItem) {
  ...
  public AttributeResult status(@jakarta.annotation.Nullable String status) {
  ...
  public AttributeResult error(@jakarta.annotation.Nullable Boolean error) {
  ...
  public AttributeResult message(@jakarta.annotation.Nullable String message) {
  ...
  public AttributeResult attribution(@jakarta.annotation.Nullable Object attribution) {
    this.attribution = JsonNullable.<Object>of(attribution);
  ...
  public Object getAttribution() {
        return attribution.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_ATTRIBUTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getAttribution_JsonNullable() {
    return attribution;
  }
  
  @JsonProperty(JSON_PROPERTY_ATTRIBUTION)
  public void setAttribution_JsonNullable(JsonNullable<Object> attribution) {
    this.attribution = attribution;
  }

  public void setAttribution(@jakarta.annotation.Nullable Object attribution) {
    this.attribution = JsonNullable.<Object>of(attribution);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.indicators, attributeResult.indicators) &&
        Objects.equals(this.status, attributeResult.status) &&
        Objects.equals(this.error, attributeResult.error) &&
        Objects.equals(this.message, attributeResult.message) &&
        equalsNullable(this.attribution, attributeResult.attribution);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(indicators, status, error, message, hashCodeNullable(attribution));
  }
